...
namespace java.math
{
	...
	{
		public static BigComplex ZERO = new BigComplex(BigDecimal.ZERO, BigDecimal.ZERO);
		public static BigComplex ONE = new BigComplex(BigDecimal.ONE, BigDecimal.ZERO);
		public static BigComplex I = new BigComplex(BigDecimal.ZERO, BigDecimal.ONE);
