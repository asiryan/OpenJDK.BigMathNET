...
{ 
	public class BigDecimalMath3
	{
		 ...
		 */
		public static BigDecimal toBigDecimal(String s, MathContext mathContext)
		{
			int len = s.Length;
			if (len < 600)
			{
		...
		static BigDecimal toBigDecimal(String s, MathContext mathContext, int splitLength)
		{
			int len = s.Length;
