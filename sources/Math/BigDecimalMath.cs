...
namespace java.math
{
	public static class BigDecimalMath
	{
		...
		private static BigDecimal ONE_HALF = BigDecimal.valueOf(0.5);
		private static BigDecimal DOUBLE_MAX_VALUE = BigDecimal.valueOf(double.MaxValue);
		private static BigDecimal ROUGHLY_TWO_PI = new BigDecimal("3.141592653589793").multiply(TWO);
		private static int EXPECTED_INITIAL_PRECISION = 15;

		private static volatile BigDecimal log2Cache;
		private static lang.Object log2CacheLock = new lang.Object();
		private static volatile BigDecimal log3Cache;
		private static lang.Object log3CacheLock = new lang.Object();
		private static volatile BigDecimal log10Cache;
		private static lang.Object log10CacheLock = new lang.Object();

		private static volatile BigDecimal piCache;
		private static Object piCacheLock = new lang.Object();
		private static volatile BigDecimal eCache;
		private static lang.Object eCacheLock = new lang.Object();
		 ...
		 */
		public static BigDecimal toBigDecimal(this String s)
		{
			return toBigDecimal(s, MathContext.UNLIMITED);
		}
		 ...
		 */
		public static BigDecimal toBigDecimal(this String s, MathContext mathContext)
		{
			int len = s.Length;
			if (len < 600)
			{
			...
			return toBigDecimal(s, mathContext, splitLength);
		}

		private static BigDecimal toBigDecimal(String s, MathContext mathContext, int splitLength)
		{
			int len = s.Length;
				...
				switch (c)
				{
					case '+':
						if (expIndex >= 0)
						{
							if (expHasSign)
							{
								throw new lang.NumberFormatException("Multiple signs in exponent");
							}
							expHasSign = true;
						}
						else
						{
							if (numberHasSign)
							{
								throw new lang.NumberFormatException("Multiple signs in number");
							}
							numberHasSign = true;
							numberIndex = i + 1;
						}
					...
					case 'E':
						if (expIndex >= 0)
						{
							throw new lang.NumberFormatException("Multiple exponent markers");
						}
						expIndex = i;
						break;
					case '.':
						if (dotIndex >= 0)
						{
							throw new lang.NumberFormatException("Multiple decimal points");
						}
						dotIndex = i;
						break;
					default:
		...
		private static int adjustScale(int scale, long exp)
		{
			...
			if (adjustedScale > int.MaxValue || adjustedScale < int.MinValue)
				throw new lang.NumberFormatException("Scale out of range: " + adjustedScale + " while adjusting scale " + scale + " to exponent " + exp);
		 ...
		 */
		public static Boolean isIntValue(this BigDecimal value)
		{
		 ...
		 */
		public static Boolean isLongValue(this BigDecimal value)
		{
		 ...
		 */
		public static Boolean isDoubleValue(this BigDecimal value)
		{
		 ...
		 */
		public static BigDecimal mantissa(this BigDecimal value)
		{
		 ...
		 */
		public static int exponent(this BigDecimal value)
		{
		 ...
		 */
		public static int significantDigits(this BigDecimal value)
		{
		 ...
		 */
		public static BigDecimal integralPart(this BigDecimal value)
		{
		 ...
		 */
		public static BigDecimal fractionalPart(this BigDecimal value)
		{
		 ...
		 */
		public static BigDecimal round(this BigDecimal value, MathContext mathContext)
		{
		 ...
		 */
		public static BigDecimal roundWithTrailingZeroes(this BigDecimal value, MathContext mathContext)
		{
		 ...
		 */
		public static BigDecimal reciprocal(this BigDecimal x, MathContext mathContext)
		{
		 ...
		 */
		public static BigDecimal pow(this BigDecimal x, BigDecimal y, MathContext mathContext)
		{
			...
			if (x.signum() == 0)
			{
				switch (y.signum())
				{
					case 0: return round(BigDecimal.ONE, mathContext);
					case 1: return round(BigDecimal.ZERO, mathContext);
				}
			}
		 ...
		 */
		public static BigDecimal pow(this BigDecimal x, long y, MathContext mathContext)
		{
		...
		private static BigDecimal powInteger(BigDecimal x, BigDecimal integerY, MathContext mathContext)
		{
			...
			{
				throw new lang.IllegalArgumentException("Not integer value: " + integerY);
			}
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal sqrt(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			switch (x.signum())
			{
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal root(this BigDecimal x, BigDecimal n, MathContext mathContext)
		{
			checkMathContext(mathContext);
			switch (x.signum())
			{
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal log(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			if (x.signum() <= 0)
			{
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal log2(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal log10(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
		...
		private static BigDecimal logUsingExponent(BigDecimal x, MathContext mathContext)
		{
			...
			int _exponent = exponent(x);
			BigDecimal _mantissa = mantissa(x);

			BigDecimal result = logUsingTwoThree(_mantissa, mc);
			if (_exponent != 0)
			{
				result = result.add(BigDecimal.valueOf(_exponent).multiply(logTen(mcDouble), mc));
			}
			return result;
		}
		...
		private static BigDecimal logUsingTwoThree(BigDecimal x, MathContext mathContext)
		{
			...
			if (factorOfTwo > 0)
			{
				...
				result = result.add(logTwo(mcDouble).multiply(BigDecimal.valueOf(factorOfTwo), mc));
			}
			else if (factorOfTwo < 0)
			{
				correctedX = correctedX.multiply(BigDecimal.valueOf(powerOfTwo), mc);
				result = result.subtract(logTwo(mcDouble).multiply(BigDecimal.valueOf(-factorOfTwo), mc));
			}

			if (factorOfThree > 0)
			{
				correctedX = correctedX.divide(BigDecimal.valueOf(powerOfThree), mc);
				result = result.add(logThree(mcDouble).multiply(BigDecimal.valueOf(factorOfThree), mc));
			}
			else if (factorOfThree < 0)
			{
				correctedX = correctedX.multiply(BigDecimal.valueOf(powerOfThree), mc);
				result = result.subtract(logThree(mcDouble).multiply(BigDecimal.valueOf(-factorOfThree), mc));
			}
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal pi(this MathContext mathContext)
		{
			checkMathContext(mathContext);
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal e(this MathContext mathContext)
		{
			checkMathContext(mathContext);
			BigDecimal result = null;
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal exp(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			if (x.signum() == 0)
			{
		...
		{
			BigDecimal _integralPart = integralPart(x);

			if (_integralPart.signum() == 0)
			{
				return expTaylor(x, mathContext);
			}

			BigDecimal fractionalPart = x.subtract(_integralPart);

			MathContext mc = new MathContext(mathContext.getPrecision() + 10, mathContext.getRoundingMode());

			BigDecimal z = BigDecimal.ONE.add(fractionalPart.divide(_integralPart, mc));
			BigDecimal t = expTaylor(z, mc);

			BigDecimal result = pow(t, _integralPart.intValueExact(), mc);
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal sin(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 6, mathContext.getRoundingMode());
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal asin(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			if (x.compareTo(BigDecimal.ONE) > 0)
			{
			...
			{
				BigDecimal xTransformed = sqrt(BigDecimal.ONE.subtract(x.multiply(x)), mc);
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal cos(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 6, mathContext.getRoundingMode());
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal acos(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			if (x.compareTo(BigDecimal.ONE) > 0)
			{
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal tan(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			if (x.signum() == 0)
			{
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal atan(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 6, mathContext.getRoundingMode());
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal atan2(this BigDecimal y, BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			...
			else
			{
				...
				{
					throw new lang.ArithmeticException("Illegal atan2(y, x) for x = 0; y = 0");
				}
			}
		}
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal cot(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			if (x.signum() == 0)
			{
				throw new lang.ArithmeticException("Illegal cot(x) for x = 0");
			}
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal acot(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 4, mathContext.getRoundingMode());
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal sinh(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 4, mathContext.getRoundingMode());
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal cosh(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 4, mathContext.getRoundingMode());
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal tanh(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 6, mathContext.getRoundingMode());
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal coth(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 6, mathContext.getRoundingMode());
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal asinh(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 10, mathContext.getRoundingMode());
			BigDecimal result = log(x.add(sqrt(x.multiply(x, mc).add(BigDecimal.ONE, mc), mc)), mc);
			return round(result, mathContext);
		}
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal acosh(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 6, mathContext.getRoundingMode());
			BigDecimal result = log(x.add(sqrt(x.multiply(x).subtract(BigDecimal.ONE), mc)), mc);
			return round(result, mathContext);
		}
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal atanh(this BigDecimal x, MathContext mathContext)
		{
			if (x.compareTo(BigDecimal.ONE) >= 0)
			{
			...
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 6, mathContext.getRoundingMode());
			BigDecimal result = log(BigDecimal.ONE.add(x).divide(BigDecimal.ONE.subtract(x), mc), mc).multiply(ONE_HALF);
			return round(result, mathContext);
		}
		 ...
		 * @throws UnsupportedOperationException if the {@link MathContext} has unlimited precision
		 */
		public static BigDecimal acoth(this BigDecimal x, MathContext mathContext)
		{
			checkMathContext(mathContext);
			MathContext mc = new MathContext(mathContext.getPrecision() + 6, mathContext.getRoundingMode());
			BigDecimal result = log(x.add(BigDecimal.ONE).divide(x.subtract(BigDecimal.ONE), mc), mc).multiply(ONE_HALF);
			return round(result, mathContext);
		}
		...
		private static void checkMathContext(MathContext mathContext)
		{
			if (mathContext.getPrecision() == 0)
			{
				throw new lang.UnsupportedOperationException("Unlimited MathContext not supported");
			}
		}
	}
}
